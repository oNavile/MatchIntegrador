...
function executarCopiaPix() {
  ...
  useEffect(() => {
    ...
    function recalcularResumo(valorPlano, nomePlano) {
      ...
      labelPlanPrice.innerText = `R$ ${valorPlano.replace('.', ',')}`;
      labelTotalPrice.innerText = `R$ ${valorPlano.replace('.', ',')}`;
    }
    ...
    inputCard?.addEventListener('input', function (e) {
      ...
      if (puro.startsWith('4')) {
        ...
        flagDetected.className =
          "badge bg-primary text-white d-inline-block";
        ...
        flagDetected.className =
          "badge bg-warning text-dark d-inline-block";
        ...
        <div className="row align-items-center g-5 mb-5">
          <div className="tab-content" id="pills-tabContent">
            <div className="d-flex justify-content-center mb-5">
              <ul
                className="nav nav-pills gap-3 custom-tabs"
                id="pills-tab"
                role="tablist"
              >
                {/* --- BOTÃO: SOU EMPRESA --- */}
                  ...
                  >
                    <div className="text-center mb-5">
                      ...
                      <p className="text-muted">
                        Preencha os dados da sua empresa para liberar o acesso à
                        plataforma
                      </p>
                    </div>
                    <form
                    ...
                    >
                      ...
                      <div className="row g-3 mb-4">
                        ...
                        <div className="col-12">
                          <label className="form-label fw-medium text-dark">
                            Logotipo ou Documento de Identificação:
                          </label>
                          <input
                            type="file"
                            name="arquivo"
                      ...
                      <div className="row g-4">
                        <div className="col-lg-7">
                          <div className="d-flex gap-2 mb-3 bg-white p-1 rounded-3 border">
                            ...
                            />
                            <label
                              className="btn btn-payment-tab flex-grow-1 py-2 text-nowrap"
                              htmlFor="pay_pix"
                            >
                            ...
                            <label
                              ...
                              htmlFor="pay_card"
                            >
                              <i className="bi bi-credit-card-2-back me-1" />{" "}
                              Cartão
                            </label>
                            <input
                              type="radio"
                          ...
                          <div className="p-4 bg-white rounded-4 border shadow-sm text-dark min-height-payment">
                            <div
                              id="wrapper-pix"
                              className="payment-method-container text-center text-md-start"
                            >
                              <div className="row align-items-center g-3">
                                ...
                                <div className="col-md-7">
                                  <h6 className="fw-bold mb-1 text-dark">
                                    ...
                                    Desconto &amp; Ativação Instantânea
                                  </h6>
                                  <p className="small text-muted mb-3">
                                    Pague via PIX e tenha o sistema liberado
                                    imediatamente na sua conta corporativa.
                                  </p>
                            ...
                            <div
                              id="wrapper-cartao"
                              className="payment-method-container d-none"
                            >
                              <div className="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                                ...
                                <div
                                  className="fs-4 text-muted d-flex gap-2"
                                  id="card-flags-preview"
                                >
                                  <i
                                  ...
                                  <span
                                    id="flag-detected"
                                    className="badge bg-dark fs-6 d-none"
                                  />
                                </div>
                              </div>
                          ...
                          >
                            <div>
                              <h6 className="fw-bold border-bottom pb-2 text-dark">
                                <i className="bi bi-cart3 me-1" /> Resumo da
                                Contratação
                              </h6>
                            ...
                            <div className="pt-3 border-top mt-4">
                              ...
                              <div className="text-center mt-2">
                                <small className="text-muted style-obs">
                                  <i className="bi bi-lock-fill" /> Checkout
                                  100% Criptografado
                                </small>
                              </div>
                            </div>
