export default function Footer() {
  return (
  <footer id="footer" className="mt-auto py-5 bg-main shadow-lg">
    <div className="container-fluid px-4 text-center text-md-start">
      <div className="row g-4">
        <div className="col-md-4">
          <h5 className="fw-bold text-dark-custom">MatchHire</h5>
          <p className="small text-muted">
            O match perfeito entre carreira e empresa.
          </p>
        </div>
        <div className="col-md-4">
          <h5 className="fw-bold text-dark-custom">Políticas</h5>
          <a
          ...
          <a
            ...
            className="text-decoration-none text-dark d-block small"
          >
            Termos de uso
          </a>
        ...
        <div className="col-md-4">
          <h5 className="fw-bold text-dark-custom">Notificações</h5>
          <h6 className="text-dark d-block small mb-1">
